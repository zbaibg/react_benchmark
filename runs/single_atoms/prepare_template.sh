...
##### Scripts 
atoms_assign_name_py_path="$REPO_ROOT/tools/atoms_assign_name.py"
...
"
    python ${atoms_assign_name_py_path} MOL.pdb MOL_fixed.pdb
...
loadamberparams ${AMPREP}/frcmod.O
loadoff ${AMPREP}/O.lib
loadamberparams ${AMPREP}/frcmod.C
loadoff ${AMPREP}/C.lib
loadamberparams ${AMPREP}/frcmod.N
loadoff ${AMPREP}/N.lib
loadamberparams ${AMPREP}/frcmod.ZN
loadoff ${AMPREP}/ZN.lib
...
"&qmmm
  ...
  kmaxqz=${kmaxq},
  ksqmaxq=${ksqmaxq},
  qmmask='${MOL_mask}', qmcharge=${charge_MOL}, spin=${spin_MOL},
/
&dftbplus
  qm_level = '%QM_LEVEL%', 
  tfermi = %TFERMI%, 
...
"&dlfind
 ...
 maxcycle=${min_maxcyc},
 tol=4.5d-5 ! maximum gradient component in a.u. (default: 4.5d-4)
 tole=1.0d-6 ! maximum predicted energy change in a.u. (default: 1.0d-6)
/
"
