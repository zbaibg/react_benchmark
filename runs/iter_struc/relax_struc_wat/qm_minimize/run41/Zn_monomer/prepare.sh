...
MOL_xyz=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/relax_struc_wat/xyz/xyz_files/Zn_monomer.xyz
RST_SOURCE_DIR=
PRMTOP_SOURCE_DIR=
charge_MOL=2
MOL_mask=":*"
...
&dftbplus
  ...
  mdftb= .false.,
  mdftb_scale= .false.,
  skroot= '/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark',
/
&xtb
  qm_level='-',
  maxiter=250,
