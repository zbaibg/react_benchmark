...
source "/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/tools/repo_env.sh"
######################## Settings ########################
...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/solv_lig_test/qm_minimize/run41/1Zn_0MIm_0MImH_6MeOH
PRMTOP_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/solv_lig_test/qm_minimize/run41/1Zn_0MIm_0MImH_6MeOH
charge_MOL=2
MOL_mask=":*"
...
&dftbplus
  ...
  mdftb= .true.,
  mdftb_scale= .true.,
  skroot= '/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/params/skf/run59',
/
&xtb
  qm_level='DFTB3-D3',
  maxiter=250,
