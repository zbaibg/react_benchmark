...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/solv_lig_test/qm_minimize/run41/MImH_monomer
PRMTOP_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/solv_lig_test/qm_minimize/run41/MImH_monomer
charge_MOL=0
MOL_mask=":*"
