...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/solv_lig_test/qm_minimize/run41/1Zn_1Im-_5Wat
PRMTOP_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/ZIF/react_benchmark/runs/iter_struc/solv_lig_test/qm_minimize/run41/1Zn_1Im-_5Wat
charge_MOL=1
MOL_mask=":*"
