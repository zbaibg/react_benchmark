...
MOL_xyz=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc/solv_lig_test/xyz/xyz_files/Zn_monomer.xyz
RST_SOURCE_DIR=
PRMTOP_SOURCE_DIR=
charge_MOL=2
MOL_mask=":*"
...
apptainer exec -e \\
  \$BIND_OPTS \\
  /home/zbai29/JR/soft/apptainer/amber_mdftb_fix2.sif bash -c "\\
