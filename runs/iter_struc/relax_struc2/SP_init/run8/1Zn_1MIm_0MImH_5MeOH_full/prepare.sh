...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc/relax_struc2/qm_minimize/run41/1Zn_1MIm_0MImH_5MeOH
PRMTOP_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc/relax_struc2/qm_minimize/run41/1Zn_1MIm_0MImH_5MeOH
charge_MOL=1
MOL_mask=":*"
