...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc/relax_struc2/qm_minimize/run41/1Zn_0MIm_2MImH_4MeOH
PRMTOP_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc/relax_struc2/qm_minimize/run41/1Zn_0MIm_2MImH_4MeOH
charge_MOL=2
MOL_mask=":*"
