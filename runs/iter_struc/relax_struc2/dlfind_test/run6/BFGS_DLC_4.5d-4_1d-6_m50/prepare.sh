...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/iter_struc/relax_struc/qm_minimize/run35/1Zn_0MIm_4MImH_2MeOH
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/iter_struc/relax_struc/qm_minimize/run35/1Zn_0MIm_4MImH_2MeOH
charge_MOL=2
MOL_mask=":*"
