...
MOL_xyz[IM-]="$REPO_ROOT/structures/monomers/IM-.xyz"
MOL_charge[IM-]=-1
MOL_ff[IM-]=gaff2
MOL_cm[IM-]=abcg2
...
xyz_to_radical_py_path="$REPO_ROOT/tools/xyz_to_radical_lib.py"
...
#create_unsupported_mol_from_xyz H3O "$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/xyz/xyz_files/H3O_monomer.xyz" 1
#create_unsupported_mol_from_xyz MI+ "${RADICAL_XYZ_DIR}/MImH2_monomer.xyz" 1
#create_unsupported_mol_from_xyz MO+ "${RADICAL_XYZ_DIR}/MeOH2_monomer.xyz" 1
