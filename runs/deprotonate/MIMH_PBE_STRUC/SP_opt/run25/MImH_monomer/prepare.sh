...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/minimize/run25/MImH_monomer
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/minimize/run25/MImH_monomer
charge_MOL=0
MOL_mask=":*"
