...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/minimize/run17/1Zn_1MImH_3MeOH
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/minimize/run17/1Zn_1MImH_3MeOH
charge_MOL=2
MOL_mask=":*"
