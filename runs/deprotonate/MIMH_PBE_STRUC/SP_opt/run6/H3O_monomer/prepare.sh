...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/minimize/run6/H3O_monomer
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/deprotonate/MIMH_PBE_STRUC/minimize/run6/H3O_monomer
charge_MOL=1
MOL_mask=":*"
