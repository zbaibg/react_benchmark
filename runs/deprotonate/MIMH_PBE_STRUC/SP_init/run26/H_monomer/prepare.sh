...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/home/zbai29/data/qmmm_test/react_benchmark/deprotonate/MIMH_PBE_STRUC/minimize/run26/H_monomer
PRMTOP_SOURCE_DIR=/home/zbai29/data/qmmm_test/react_benchmark/deprotonate/MIMH_PBE_STRUC/minimize/run26/H_monomer
charge_MOL=1
MOL_mask=":*"
...
&dftbplus
  ...
  mdftb= .true.,
  mdftb_scale= .true.,
  skroot= '/home/zbai29/soft/m3ob-test_Zn',
/
&xtb
  qm_level='DFTB3-D3',
  maxiter=250,
