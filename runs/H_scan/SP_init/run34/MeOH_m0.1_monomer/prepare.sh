...
MOL_xyz=/home/zbai29/data/qmmm_test/react_benchmark/H_scan/xyz/xyz_files/MeOH_m0.1_monomer.xyz
RST_SOURCE_DIR=
PRMTOP_SOURCE_DIR=
charge_MOL=0
MOL_mask=":*"
...
&dftbplus
  ...
  mdftb= .true.,
  mdftb_scale= .true.,
  skroot= '/home/zbai29/data/qmmm_test/react_benchmark/refit/_repopt/run34/optimized_skf',
/
&xtb
  qm_level='DFTB3-D3',
  maxiter=250,
