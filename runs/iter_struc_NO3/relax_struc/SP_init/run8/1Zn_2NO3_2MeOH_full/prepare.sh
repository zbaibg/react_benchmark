...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc_NO3/relax_struc/qm_minimize/run41/1Zn_2NO3_2MeOH
PRMTOP_SOURCE_DIR=/mnt/cephfs/scratch/zbai29/data_JR/qmmm_test/react_benchmark/iter_struc_NO3/relax_struc/qm_minimize/run41/1Zn_2NO3_2MeOH
charge_MOL=0
MOL_mask=":*"
