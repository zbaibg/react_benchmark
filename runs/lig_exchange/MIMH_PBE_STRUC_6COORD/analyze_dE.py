...
REACTIONS = [
    ('1Zn_0MImH_6MeOH', '1Zn_1MImH_5MeOH'),
    ('1Zn_1MImH_5MeOH', '1Zn_2MImH_3MeOH'),
    ('1Zn_2MImH_3MeOH', '1Zn_3MImH_2MeOH'),
    ('1Zn_3MImH_2MeOH', '1Zn_5MImH_0MeOH'),
]
...
def analyze_runs():
    ...
    for base_dir in SP_DIRS + MIN_DIRS:
        ...
        for run_path in run_dirs:
            ...
            e_mim = get_Etot_amber(os.path.join(run_path, 'MImH_monomer', 'min.out'))
