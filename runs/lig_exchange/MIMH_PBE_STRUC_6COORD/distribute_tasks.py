...
import shutil
# ============ Configuration ============
QM_RUNS = ["run10", "run11", 'run12','run13','run14','run16','run24','run23']  # QM method run directories
MAX_QM_WORKERS = 40           # Maximum number of QM workers
MAX_OTHER_WORKERS = 50       # Maximum number of other workers
QM_CPUS_PER_TASK = 16          # CPUs per task for QM workers
OTHER_CPUS_PER_TASK = 6       # CPUs per task for other workers
# =======================================
