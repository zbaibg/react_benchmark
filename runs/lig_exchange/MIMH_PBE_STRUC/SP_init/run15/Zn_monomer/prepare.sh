...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/home/zbai29/data/qmmm_test/lig_exchange_gas_pbe_struc_MIMH/minimize/run15/Zn_monomer
PRMTOP_SOURCE_DIR=/home/zbai29/data/qmmm_test/lig_exchange_gas_pbe_struc_MIMH/minimize/run15/Zn_monomer
charge_MOL=2
MOL_mask=":*"
...
&dftbplus
  ...
  mdftb= .true.,
  mdftb_scale= .true.,
  skroot= '/home/zbai29/soft/3ob-3-1',
/
&xtb
  qm_level='DFTB3-D3',
  maxiter=250,
