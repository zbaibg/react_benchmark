...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIMH_PBE_STRUC/minimize/run8/MImH_monomer
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIMH_PBE_STRUC/minimize/run8/MImH_monomer
charge_MOL=0
MOL_mask=":*"
