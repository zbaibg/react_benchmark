...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIMH_PBE_STRUC/minimize/run17/Zn_monomer
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIMH_PBE_STRUC/minimize/run17/Zn_monomer
charge_MOL=2
MOL_mask=":*"
