...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR=/home/zbai29/data/qmmm_test/lig_exchange_gas2/minimize/run15/Zn_monomer
PRMTOP_SOURCE_DIR=/home/zbai29/data/qmmm_test/lig_exchange_gas2/minimize/run15/Zn_monomer
charge_MOL=2
MOL_mask=":*"
...
[ -d /scratch/"\$USER" ] && BIND_OPTS="\$BIND_OPTS --bind /scratch/\$USER"
