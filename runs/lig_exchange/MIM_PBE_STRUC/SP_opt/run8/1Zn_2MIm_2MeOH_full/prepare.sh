...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run8/1Zn_2MIm_2MeOH
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run8/1Zn_2MIm_2MeOH
charge_MOL=0
MOL_mask=":*"
