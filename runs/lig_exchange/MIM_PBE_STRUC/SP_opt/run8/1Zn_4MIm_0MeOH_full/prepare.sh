...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run8/1Zn_4MIm_0MeOH
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run8/1Zn_4MIm_0MeOH
charge_MOL=-2
MOL_mask=":*"
