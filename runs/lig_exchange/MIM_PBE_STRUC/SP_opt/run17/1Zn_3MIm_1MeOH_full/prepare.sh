...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run17/1Zn_3MIm_1MeOH
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run17/1Zn_3MIm_1MeOH
charge_MOL=-1
MOL_mask=":*"
