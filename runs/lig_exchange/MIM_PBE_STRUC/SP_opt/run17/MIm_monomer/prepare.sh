...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run17/MIm_monomer
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run17/MIm_monomer
charge_MOL=-1
MOL_mask=":*"
