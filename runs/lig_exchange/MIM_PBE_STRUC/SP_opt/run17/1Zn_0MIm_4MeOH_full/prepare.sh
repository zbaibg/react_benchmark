...
MOL_xyz=%MOL_XYZ%
RST_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run17/1Zn_0MIm_4MeOH
PRMTOP_SOURCE_DIR="$REPO_ROOT/runs/lig_exchange/MIM_PBE_STRUC/minimize/run17/1Zn_0MIm_4MeOH
charge_MOL=2
MOL_mask=":*"
